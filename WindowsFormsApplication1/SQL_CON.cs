...
namespace WindowsFormsApplication1
{
    class SQL_CON
    {
        ...
        public SQL_CON(){
            conn = new SqlConnection("Data Source = dbdesign.database.windows.net;" +
                " Initial Catalog = SAD_N6; User ID = leviae@bgufbm.onmicrosoft.com;" +
                " Password = leviTAL04 ; Authentication = 'Active Directory Password'");//update this!!
